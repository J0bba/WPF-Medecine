...
namespace virsol_tMedicalDotNet.ServicePatient {
    ...
    public partial class Patient : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private virsol_tMedicalDotNet.ServicePatient.Observation[] ObservationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public virsol_tMedicalDotNet.ServicePatient.Observation[] Observations {
            get {
    ...
    public interface IServicePatient {
        ...
        virsol_tMedicalDotNet.ServicePatient.Patient[] GetListPatient();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetListPatient", ReplyAction="http://tempuri.org/IServicePatient/GetListPatientResponse")]
        System.Threading.Tasks.Task<virsol_tMedicalDotNet.ServicePatient.Patient[]> GetListPatientAsync();
        ...
        virsol_tMedicalDotNet.ServicePatient.Patient GetPatient(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetPatient", ReplyAction="http://tempuri.org/IServicePatient/GetPatientResponse")]
        System.Threading.Tasks.Task<virsol_tMedicalDotNet.ServicePatient.Patient> GetPatientAsync(int id);
        ...
        bool AddPatient(virsol_tMedicalDotNet.ServicePatient.Patient user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/AddPatient", ReplyAction="http://tempuri.org/IServicePatient/AddPatientResponse")]
        System.Threading.Tasks.Task<bool> AddPatientAsync(virsol_tMedicalDotNet.ServicePatient.Patient user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePatientChannel : virsol_tMedicalDotNet.ServicePatient.IServicePatient, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePatientClient : System.ServiceModel.ClientBase<virsol_tMedicalDotNet.ServicePatient.IServicePatient>, virsol_tMedicalDotNet.ServicePatient.IServicePatient {
        ...
        public virsol_tMedicalDotNet.ServicePatient.Patient[] GetListPatient() {
            return base.Channel.GetListPatient();
        }
        
        public System.Threading.Tasks.Task<virsol_tMedicalDotNet.ServicePatient.Patient[]> GetListPatientAsync() {
            return base.Channel.GetListPatientAsync();
        }
        
        public virsol_tMedicalDotNet.ServicePatient.Patient GetPatient(int id) {
            return base.Channel.GetPatient(id);
        }
        
        public System.Threading.Tasks.Task<virsol_tMedicalDotNet.ServicePatient.Patient> GetPatientAsync(int id) {
