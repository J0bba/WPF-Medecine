...
namespace virsol_tMedicalDotNet.ServiceUser {
    ...
    public interface IServiceUser {
        ...
        virsol_tMedicalDotNet.ServiceUser.User[] GetListUser();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetListUser", ReplyAction="http://tempuri.org/IServiceUser/GetListUserResponse")]
        System.Threading.Tasks.Task<virsol_tMedicalDotNet.ServiceUser.User[]> GetListUserAsync();
        ...
        virsol_tMedicalDotNet.ServiceUser.User GetUser(string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetUser", ReplyAction="http://tempuri.org/IServiceUser/GetUserResponse")]
        System.Threading.Tasks.Task<virsol_tMedicalDotNet.ServiceUser.User> GetUserAsync(string login);
        ...
        bool AddUser(virsol_tMedicalDotNet.ServiceUser.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/AddUser", ReplyAction="http://tempuri.org/IServiceUser/AddUserResponse")]
        System.Threading.Tasks.Task<bool> AddUserAsync(virsol_tMedicalDotNet.ServiceUser.User user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceUserChannel : virsol_tMedicalDotNet.ServiceUser.IServiceUser, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceUserClient : System.ServiceModel.ClientBase<virsol_tMedicalDotNet.ServiceUser.IServiceUser>, virsol_tMedicalDotNet.ServiceUser.IServiceUser {
        ...
        public virsol_tMedicalDotNet.ServiceUser.User[] GetListUser() {
            return base.Channel.GetListUser();
        }
        
        public System.Threading.Tasks.Task<virsol_tMedicalDotNet.ServiceUser.User[]> GetListUserAsync() {
            return base.Channel.GetListUserAsync();
        }
        
        public virsol_tMedicalDotNet.ServiceUser.User GetUser(string login) {
            return base.Channel.GetUser(login);
        }
        
        public System.Threading.Tasks.Task<virsol_tMedicalDotNet.ServiceUser.User> GetUserAsync(string login) {
            return base.Channel.GetUserAsync(login);
        }
        
        public bool AddUser(virsol_tMedicalDotNet.ServiceUser.User user) {
            return base.Channel.AddUser(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddUserAsync(virsol_tMedicalDotNet.ServiceUser.User user) {
